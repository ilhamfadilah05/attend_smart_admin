...
class FormCreateEditEmployee extends StatelessWidget {
  FormCreateEditEmployee({super.key, required this.isUpdateEmployee});
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<CreateEmployeeBloc, CreateEmployeeState>(
      builder: (context, state) {
        print("STATE ${state.formStatus}");
        print("IS UPDATE  ${state.isUpdate}");
        return Form(
          key: _formKey,
                        ...
                        : InkWell(
                            onTap: () async {
                              ...
                              if (dataImage != null) {
                                ...
                                if (empl == null) {
                                  empl =
                                      EmployeeModel(image: dataImage['image']);
                                } else {
                                  empl =
                                      empl.copyWith(image: dataImage['image']);
                                }
                                context.read<CreateEmployeeBloc>().add(
                                    CreateEmployeeChangedEvent(
                                        employeeData: empl, isUpdate: false));
